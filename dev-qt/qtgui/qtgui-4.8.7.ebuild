...
IUSE="+accessibility cups egl +glib gtkstyle mng nas nis qt3support tiff trace xinerama +xv aqua"
...
RDEPEND="
	...
	>=dev-qt/qtcore-4.8.7[aqua=,debug=,glib=,qt3support=,${MULTILIB_USEDEP}]
